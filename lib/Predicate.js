...
function itemMatches(text, item, options) {
  /**
   ...
   */
  var separator = options.separator, regexp = options.separator_regexp,
    items = [];
...
Predicate.prototype.evaluate = function (inputData, fields) {
  ...
  if ((typeof this.term) !== 'undefined') {
    if (fields[this.field].optype == 'text') {
      ...
      inputInfo = itemMatches(inputData[this.field], this.term, options);
    }
