...
BigMLPrediction.prototype.create = function (model, inputData, args, cb) {
  /**
   * Creates a prediction and builds costumized error and resource info
   *
