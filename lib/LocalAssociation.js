...
LocalAssociation.prototype.getItems = function (field, names, inputMap,
                                                filterFunction) {
  /**
...
LocalAssociation.prototype.getRules = function (
...
LocalAssociation.prototype.rulesCSV = function (fileName, rules) {
  /**
   ...
   */
  var len = rules.length, index, rows = [], csvStream, rule;
