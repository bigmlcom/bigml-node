...
function Cluster(connection) {
  Resource.call(this, connection);
}

Cluster.prototype = new Resource();

Cluster.prototype.parent = Resource.prototype;

Cluster.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates a cluster and builds customized error and resource info
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the cluster. First parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.CLUSTER);
...
Cluster.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.CLUSTER, query, cb);
};

Cluster.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
