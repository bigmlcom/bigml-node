...
function Deepnet(connection) {
  Resource.call(this, connection);
}

Deepnet.prototype = new Resource();

Deepnet.prototype.parent = Resource.prototype;

Deepnet.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates a deepnet and builds customized error and resource
   * infor
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the deepnet model. First' +
    ' parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.DEEPNET);
...
Deepnet.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.DEEPNET, query, cb);
};


Deepnet.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
