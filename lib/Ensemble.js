...
Ensemble.prototype.create = function (datasets, args, retry, cb) {
  ...
  var self = this, options, resource, resources, datasetsArray = false,
    ...
    sendRequest,
    reqOptions = utils.createRequest(constants.ENSEMBLE);
...
Ensemble.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.ENSEMBLE, query, cb);
};

Ensemble.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
