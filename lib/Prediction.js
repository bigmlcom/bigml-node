...
Prediction.prototype.create = function (modelResource, inputData, args,
  ...
  self.parent.create.call(self, constants.PREDICTION,
                          constants.SUPERVISED_MODELS, message,
                          resourceId.resource,
                          options.args, options.retry, options.cb);
};

Prediction.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.PREDICTION, query, cb);
};

Prediction.prototype.createAndWait = function (model, inputData, args,
                                               retry, cb) {
  var self = this;
  ...
  self.create(model, inputData, args, retry,
    function(error, data) {
