...
BatchAnomalyScore.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.BATCH_ANOMALY_SCORE, query, cb);
};
...
BatchAnomalyScore.prototype.createAndWait = function (anomaly, dataset, args,
                                                      retry, cb) {
  var self = this;
  ...
  self.create(anomaly, dataset, args, retry,
    function(error, data) {
