...
function TimeSeries(connection) {
  Resource.call(this, connection);
}

TimeSeries.prototype = new Resource();

TimeSeries.prototype.parent = Resource.prototype;

TimeSeries.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates a time-series and builds customized error and resource
   * infor
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the time series model. First' +
    ' parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.TIME_SERIES);
...
TimeSeries.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.TIME_SERIES, query, cb);
};


TimeSeries.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
