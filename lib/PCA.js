...
function PCA(connection) {
  Resource.call(this, connection);
}

PCA.prototype = new Resource();

PCA.prototype.parent = Resource.prototype;

PCA.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates a Principal Component Analysis model
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the PCA model. First' +
    ' parameter must be' +
...
PCA.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.PCA, query, cb);
};

PCA.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
