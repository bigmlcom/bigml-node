...
function TopicModel(connection) {
  Resource.call(this, connection);
}

TopicModel.prototype = new Resource();

TopicModel.prototype.parent = Resource.prototype;

TopicModel.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates an TopicModel and builds customized error and resource info
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the TopicModel. First parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.TOPIC_MODEL);
...
TopicModel.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.TOPIC_MODEL, query, cb);
};

TopicModel.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
