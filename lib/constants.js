...
var createErrors = module.exports.HTTP_COMMON_ERRORS.slice();
createErrors.push(module.exports.HTTP_PAYMENT_REQUIRED);
createErrors.push(module.exports.HTTP_FORBIDDEN);
define("HTTP_CREATE_ERRORS", createErrors);
var updateErrors = module.exports.HTTP_COMMON_ERRORS.slice();
updateErrors.push(module.exports.HTTP_PAYMENT_REQUIRED);
updateErrors.push(module.exports.HTTP_METHOD_NOT_ALLOWED);
...
define("ID_SHARED_PATTERN", /^[a-zA-Z0-9]{27}$/);
