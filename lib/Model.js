...
Model.prototype.predict = function(inputData) {
  ...
  for (field in inputData) {
    if (inputData[field] == null ||
        (!(field in this.invertedFields))) delete inputData[field];
    else {
      newInputData['' + this.invertedFields[field]] = inputData[field];
    }
  }
