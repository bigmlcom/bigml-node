...
Model.prototype.create = function (datasets, args, retry, cb) {
  /**
  ...
  var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the model. First parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.MODEL);
...
Model.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
...
Model.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.MODEL, query, cb);
};
