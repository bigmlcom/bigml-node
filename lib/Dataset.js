...
Dataset.prototype.create = function (sourceOrDataset, args, finished, cb) {
  /**
  ...
  var self = this, options, datasetsArray = false,
  ...
  if (Object.prototype.toString.call(sourceOrDataset) === '[object Array]') {
    resourceId = utils.getResource(sourceOrDataset[0]);
    datasetsArray = true;
  } else {
