...
BigMLEvaluation.prototype.create = function (modelOrEnsemble, dataset, args, cb) {
  /**
   * Creates an evaluation and builds costumized error and resource info
   *
