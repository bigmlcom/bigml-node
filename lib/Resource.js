...
Resource.prototype.update = function (resource, body, retry, cb) {
  ...
  var options, resourceId, reqOptions, message;
  if (arguments.length > 0) {
    resourceId = utils.getResource(resource);
  ...
  this.connection.request(reqOptions,
      ...
      return utils.requestResponse('resource', this, constants.HTTP_ACCEPTED,
                                   [constants.HTTP_PAYMENT_REQUIRED,
                                    constants.HTTP_UNAUTHORIZED,
