...
function Association(connection) {
  Resource.call(this, connection);
}


Association.prototype = new Resource();

Association.prototype.parent = Resource.prototype;

Association.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates an association and builds customized error and resource info
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the association. First parameter must be' +
    ' a dataset or datasets array.',
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.ASSOCIATION);
...
Association.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.ASSOCIATION, query, cb);
};

Association.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
