...
function LinearRegression(connection) {
  Resource.call(this, connection);
}

LinearRegression.prototype = new Resource();

LinearRegression.prototype.parent = Resource.prototype;

LinearRegression.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates a linear regression and builds customized error and resource
   * infor
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the linear regression model. First' +
    ' parameter must be' +
    ...
    reqOptions = {
      method: 'POST',
      resourceType: constants.LINEAR_REGRESSION,
      endpoint: '/',
      store: true
    };
...
LinearRegression.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.LINEAR_REGRESSION, query, cb);
};

LinearRegression.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
  ...
  self.create(datasets, args, retry,
    function(error, data) {
