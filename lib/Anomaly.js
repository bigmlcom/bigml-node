...
Anomaly.prototype.create = function (datasets, args, retry, cb) {
  ...
  var self = this, options, resource, resources, datasetsArray = false,
    ...
    resourceId,
    sendRequest,
    reqOptions = utils.createRequest(constants.ANOMALY);
...
Anomaly.prototype.list = function (query, cb) {
  this.parent.list.call(this, constants.ANOMALY, query, cb);
};

Anomaly.prototype.createAndWait = function (datasets, args, retry, cb) {
  var self = this;
