...
function BigMLModel(connection) {
...
BigMLModel.prototype = new BigMLResource();

BigMLModel.prototype.parent = BigMLResource.prototype;

BigMLModel.prototype.create = function (dataset, args, cb) {
  /**
...
BigMLModel.prototype.list = function (query, cb) {
  this.parent.list.call(this, 'model', query, cb);
}


module.exports = BigMLModel;
