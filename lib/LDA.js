...
function LDA(connection) {
  Resource.call(this, connection);
}

LDA.prototype = new Resource();

LDA.prototype.parent = Resource.prototype;

LDA.prototype.create = function (datasets, args, retry, cb) {
  /**
   * Creates an LDA and builds customized error and resource info
   *
...
var self = this, options, resource, resources, datasetsArray = false,
    message = 'Failed to create the LDA. First parameter must be' +
...
LDA.prototype.list = function (query, cb) {
  this.parent.list.call(this, 'lda', query, cb);
};
