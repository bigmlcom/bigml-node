...
describe(scriptName + ': Manage local model objects', function () {
  var sourceId, source = new bigml.Source(), path = './data/iris.csv',
    ...
    args = {"missing_splits": false, "balance_objective": true},
    ...
    prediction1 = [ { prediction: 'Iris-setosa', probability: 1 },
  { prediction: 'Iris-versicolor',
    probability: 0 },
  { prediction: 'Iris-virginica',
    probability: 0 } ],
    prediction2 = [ { prediction: 'Iris-setosa', probability: 0 },
  { prediction: 'Iris-versicolor',
    probability: 0.5 },
  { prediction: 'Iris-virginica',
    probability: 0.5 } ];
  ...
  before(function (done) {
    source.create(path, undefined, function (error, data) {
      ...
      dataset.create(sourceId, undefined, function (error, data) {
        ...
        model.create(datasetId, args, function (error, data) {
          assert.equal(data.code, bigml.constants.HTTP_CREATED);
