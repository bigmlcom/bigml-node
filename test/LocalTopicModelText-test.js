...
describe(scriptName + ': Manage local topic model objects', function () {
  var sourceId, source = new bigml.Source(), path = './data/spam.csv',
    ...
    localTopicModel,
    distribution1 = [
      { name: 'Topic 00', probability: 0.025325767129045815 },
      { name: 'Topic 01', probability: 0.002627154266498529 },
      { name: 'Topic 02', probability: 0.2630306851618327 },
      ...
      { name: 'Topic 06', probability: 0.002627154266498529 },
      { name: 'Topic 07', probability: 0.6879991593106348 },
    ...
    distribution2 = [
      ...
      { name: 'Topic 02', probability: 0.00741399762752076 },
      { name: 'Topic 03', probability: 0.00741399762752076 },
      { name: 'Topic 04', probability: 0.00741399762752076 },
      { name: 'Topic 05', probability: 0.00741399762752076 },
      ...
      { name: 'Topic 09', probability: 0.00741399762752076 },
      { name: 'Topic 10', probability: 0.00741399762752076 },
      { name: 'Topic 11', probability: 0.9184460260972716 } ],
    distribution3 = [
